...
module.exports = function(proto) {
   ...
   *
   * @method MencoderCommand#inputFormat
   * @category Input
   ...
   *
   * @method MencoderCommand#inputFps
   * @category Input
   ...
   *
   * @method MencoderCommand#seekInput
   * @category Input
