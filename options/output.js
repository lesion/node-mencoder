...
module.exports = function(proto) {
   ...
   * Set output duration
   *
   * @method MencoderCommand#duration
   * @category Output
   ...
   *
   * @method MencoderCommand#flvmeta
   * @category Output
