...
module.exports = function(proto) {
   ...
   *
   * @method MencoderCommand#noAudio
   * @category Audio
   * @aliases withNoAudio
   ...
   * Specify audio codec
   *
   * @method MencoderCommand#audioCodec
   * @category Audio
   ...
   *
   * @method MencoderCommand#audioBitrate
   * @category Audio
   ...
   *
   * @method MencoderCommand#audioChannels
   * @category Audio
   ...
   *
   * @method MencoderCommand#audioFrequency
   * @category Audio
   ...
   *
   * @method MencoderCommand#audioQuality
   * @category Audio
   ...
   * );
   *
   * @method MencoderCommand#audioFilters
