...
module.exports = function recipes(proto) {
  /**
   * Execute mencoder command and save output to a file
   *
   * @method MencoderCommand#save
   * @category Processing
   * @aliases saveToFile
   *
  ...
  /**
   * Execute mencoder command and save output to a stream
   *
   * If 'stream' is not specified, a PassThrough stream is created and returned.
   * 'options' will be used when piping mencoder output to the output stream
   * (@see http://nodejs.org/api/stream.html#stream_readable_pipe_destination_options)
   *
   * @method MencoderCommand#pipe
   * @category Processing
   ...
   *
   * @method MencoderCommand#screenshots
   * @category Processing
   ...
   * @param {String} [config.size] screenshot size, with the same syntax as {@link MencoderCommand#size}
